...
// Sovereign player — no iframes ever.
// HLS.js for .m3u8, native <video> for .mp4/.mkv
// Multi-audio switching via hls.audioTrack
// Auto-fallback chain: tries every stream before showing error
...
const IC = {
  ...
  VolHi: () => (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
      <polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5" stroke="currentColor" strokeWidth="1.5" fill="none"/>
  ...
  ExitFS: () => (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
      <path d="M4 14h6v6M20 10h-6V4M14 10l7-7M10 14l-7 7" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  ),
  PiP: () => (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
      <rect x="2" y="5" width="20" height="14" rx="2" stroke="currentColor" strokeWidth="1.5" fill="none"/>
      <rect x="10" y="11" width="10" height="6" rx="1" stroke="currentColor" strokeWidth="1.5" fill="currentColor"/>
    </svg>
  ),
  Close: () => (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
  ...
  Rw10: () => (
    <svg width="48" height="48" viewBox="0 0 64 64" fill="none">
      <path d="M16 24A20 20 0 1 1 16 46" stroke="currentColor" strokeWidth="3" strokeLinecap="round"/>
      <path d="M25 15 L15 24 L25 33" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"/>
      <text x="32" y="38" textAnchor="middle" fill="currentColor" fontSize="14" fontWeight="700" fontFamily="system-ui">10</text>
    </svg>
  ),
  Fw10: () => (
    <svg width="48" height="48" viewBox="0 0 64 64" fill="none">
      <path d="M48 24A20 20 0 1 0 48 46" stroke="currentColor" strokeWidth="3" strokeLinecap="round"/>
      <path d="M39 15 L49 24 L39 33" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"/>
      <text x="32" y="38" textAnchor="middle" fill="currentColor" fontSize="14" fontWeight="700" fontFamily="system-ui">10</text>
    </svg>
  ),
  Play: () => (
    <svg width="52" height="52" viewBox="0 0 64 64" fill="none">
      <path d="M22 14 L52 32 L22 50 Z" fill="currentColor" stroke="currentColor" strokeWidth="2" strokeLinejoin="round"/>
    </svg>
  ),
  Pause: () => (
    <svg width="52" height="52" viewBox="0 0 64 64" fill="none">
      <rect x="18" y="14" width="9" height="36" rx="3" fill="currentColor"/>
      <rect x="37" y="14" width="9" height="36" rx="3" fill="currentColor"/>
    </svg>
  ),
  Back: () => (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
...
export default function PrimePlayer({
  ...
  const [panel,      setPanel]      = useState(null); // null | 'sub' | 'quality' | 'vol'
  const [skipFX,     setSkipFX]     = useState(null); // 'f' | 'b'
