...
import { 
  Search, Play, Info, Plus, ChevronRight, ChevronLeft, Download, 
  Share2, CheckCircle2, ThumbsUp, ChevronDown, Grip, Loader, List, 
  ArrowLeft, X, Volume2, VolumeX, Trophy, Signal, Clock, Ban, 
  Eye, Bookmark, TrendingUp, Monitor 
} from 'lucide-react';

// --- GLOBAL HLS REFERENCE ---
// Ensure <script src="https://cdn.jsdelivr.net/npm/hls.js@latest"></script> is in index.html
...
const SportsPage = () => {
    // SPECIAL STREAMS MANUALLY INJECTED
    const SPECIAL_STREAM = {
        name: "Special Event / IPL Feed",
        logo: "https://upload.wikimedia.org/wikipedia/en/4/41/Star_Sports.png",
...
const SportsPlayer = () => {
    ...
    useEffect(() => {
        ...
        if (Hls.isSupported()) {
            // --- THE "EXTENSION" MIMIC: CUSTOM INTERCEPTOR LOADER ---
            // This class overrides the default network loader of HLS.js
            // It mimics the extension by forcing the proxy on EVERYTHING (manifests, chunks, keys).
            ...
            // LOAD THE MANIFEST 
            // We pass the raw URL. The interceptor will wrap it.
            ...
            // Safari usually handles CORS better naturally or requires the proxy in src
