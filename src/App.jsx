...
const ALL_DLHD_CHANNELS = [
  { name: "ABC USA", id: "51" },
  { name: "AHC (American Heroes Channel)", id: "206" },
  { name: "Antenna TV USA", id: "283" },
  { name: "A&E USA", id: "302" },
  { name: "AMC USA", id: "303" },
  { name: "Animal Planet", id: "304" },
  { name: "Astro SuperSport 1", id: "123" },
  { name: "Astro SuperSport 2", id: "124" },
  { name: "Astro SuperSport 3", id: "125" },
  { name: "Astro SuperSport 4", id: "126" },
  { name: "Arena Sport 1 Premium", id: "134" },
  { name: "Arena Sport 2 Premium", id: "135" },
  { name: "Arena Sport 3 Premium", id: "139" },
  ...
  { name: "Alkass One", id: "781" },
  { name: "Alkass Two", id: "782" },
  { name: "Alkass Three", id: "783" },
  { name: "Alkass Four", id: "784" },
  { name: "Arena Sport 1 BiH", id: "579" },
  { name: "Abu Dhabi Sports 1 UAE", id: "600" },
  { name: "Abu Dhabi Sports 2 UAE", id: "601" },
  { name: "Abu Dhabi Sports 1 Premium", id: "609" },
  { name: "Abu Dhabi Sports 2 Premium", id: "610" },
  { name: "Astro Cricket", id: "370" },
  { name: "Antena 3 Spain", id: "531" },
  { name: "Arena Sports Tenis Serbia", id: "612" },
  { name: "ACC Network USA", id: "664" },
  { name: "Adult Swim", id: "295" },
  { name: "A Sport PK", id: "269" },
  ...
  { name: "A Spor Turkey", id: "1011" },
  { name: "beIN Sports MENA English 1", id: "61" },
  { name: "beIN Sports MENA English 2", id: "90" },
  { name: "beIN Sports 1 Arabic", id: "91" },
  { name: "beIN Sports 2 Arabic", id: "92" },
  { name: "beIN Sports 3 Arabic", id: "93" },
  { name: "beIN Sports 4 Arabic", id: "94" },
  { name: "beIN Sports 5 Arabic", id: "95" },
  { name: "beIN Sports 6 Arabic", id: "96" },
  ...
  { name: "beIN SPORTS 1 France", id: "116" },
  { name: "beIN SPORTS 2 France", id: "117" },
  { name: "beIN SPORTS 3 France", id: "118" },
  { name: "beIN SPORTS 1 Turkey", id: "62" },
  { name: "beIN SPORTS 2 Turkey", id: "63" },
  { name: "beIN SPORTS 3 Turkey", id: "64" },
  { name: "beIN SPORTS 4 Turkey", id: "67" },
  { name: "BeIN Sports HD Qatar", id: "578" },
  { name: "BeIN SPORTS USA", id: "425" },
  { name: "beIN SPORTS en Espa単ol", id: "372" },
  ...
  { name: "BBC News Channel HD", id: "349" },
  { name: "BBC One UK", id: "356" },
  { name: "BBC Two UK", id: "357" },
  { name: "BBC Three UK", id: "358" },
  { name: "BBC Four UK", id: "359" },
  { name: "BIG TEN Network (BTN USA)", id: "397" },
  { name: "beIN Sports 1 Malaysia", id: "712" },
  { name: "beIN Sports 2 Malaysia", id: "713" },
  { name: "beIN Sports 3 Malaysia", id: "714" },
  { name: "BFM TV France", id: "957" },
  { name: "bein Sports 5 Turkey", id: "1010" },
  { name: "Bandsports Brasil", id: "275" },
  ...
  { name: "CW USA", id: "300" },
  { name: "CNBC USA", id: "309" },
  { name: "Comedy Central", id: "310" },
  { name: "Cartoon Network", id: "339" },
  { name: "CNN USA", id: "345" },
  { name: "Cinemax USA", id: "374" },
  { name: "Cuatro Spain", id: "535" },
  { name: "Channel 4 UK", id: "354" },
  { name: "Channel 5 UK", id: "355" },
  { name: "CBS Sports Network (CBSSN)", id: "308" },
  { name: "Canal+ France", id: "121" },
  { name: "Canal+ Sport France", id: "122" },
  { name: "Canal+ Foot France", id: "463" },
  { name: "Canal+ Sport360", id: "464" },
  { name: "Canal 11 Portugal", id: "540" },
  { name: "Canal+ Sport Poland", id: "48" },
  { name: "Canal+ Sport 2 Poland", id: "73" },
  ...
  { name: "Combate Brasil", id: "89" },
  { name: "Cosmote Sport 1 HD", id: "622" },
  { name: "Cosmote Sport 2 HD", id: "623" },
  { name: "Cosmote Sport 3 HD", id: "624" },
  { name: "Cosmote Sport 4 HD", id: "625" },
  { name: "Cosmote Sport 5 HD", id: "626" },
  ...
  { name: "DAZN 1 Spain", id: "445" },
  { name: "DAZN 2 Spain", id: "446" },
  { name: "DAZN 3 Spain", id: "447" },
  { name: "DAZN 4 Spain", id: "448" },
  { name: "DAZN F1 ES", id: "537" },
  { name: "DAZN LaLiga", id: "538" },
  { name: "DAZN Portugal FIFA Mundial de Clubes", id: "918" },
  { name: "DR1 Denmark", id: "801" },
  { name: "DR2 Denmark", id: "802" },
  { name: "DAZN Ligue 1 France", id: "960" },
  { name: "Digi Sport 1 Romania", id: "400" },
  { name: "Digi Sport 2 Romania", id: "401" },
  { name: "Digi Sport 3 Romania", id: "402" },
  { name: "Digi Sport 4 Romania", id: "403" },
  ...
  { name: "Dubai Sports 1 UAE", id: "604" },
  { name: "Dubai Sports 2 UAE", id: "605" },
  { name: "Dubai Sports 3 UAE", id: "606" },
  ...
  { name: "Eleven Sports 2 Portugal", id: "456" },
  { name: "Eleven Sports 3 Portugal", id: "457" },
  { name: "Eleven Sports 4 Portugal", id: "458" },
  { name: "Eleven Sports 5 Portugal", id: "459" },
  { name: "EuroSport 1 Greece", id: "41" },
  { name: "EuroSport 2 Greece", id: "42" },
  { name: "EuroSport 1 Poland", id: "57" },
  { name: "EuroSport 2 Poland", id: "58" },
  { name: "Eurosport 1 SW", id: "231" },
  { name: "Eurosport 2 SW", id: "232" },
  ...
  { name: "ESPN Brasil", id: "81" },
  { name: "ESPN2 Brasil", id: "82" },
  { name: "ESPN3 Brasil", id: "83" },
  { name: "ESPN4 Brasil", id: "85" },
  { name: "ESPN Argentina", id: "149" },
  { name: "ESPN2 Argentina", id: "150" },
  { name: "ESPN Deportes", id: "375" },
  { name: "ESPNews", id: "288" },
  ...
  { name: "Fox Sports 1 USA", id: "39" },
  { name: "Fox Sports 2 USA", id: "758" },
  { name: "FOX Soccer Plus", id: "756" },
  ...
  { name: "Fox Sports Argentina", id: "787" },
  { name: "Fox Sports 2 Argentina", id: "788" },
  ...
  { name: "History USA", id: "322" },
  { name: "Headline News", id: "323" },
  { name: "HGTV", id: "382" },
  { name: "Happy TV Serbia", id: "846" },
  { name: "HOT3 Israel", id: "553" },
  { name: "ITV 1 UK", id: "350" },
  { name: "ITV 2 UK", id: "351" },
  { name: "ITV 3 UK", id: "352" },
  { name: "ITV 4 UK", id: "353" },
  { name: "ITV Quiz", id: "876" },
  { name: "Italia 1 Italy", id: "854" },
  ...
  { name: "LaLigaTV UK", id: "276" },
  { name: "Law & Crime Network", id: "278" },
  { name: "LaLiga SmartBank TV", id: "539" },
  { name: "L'Equipe France", id: "645" },
  { name: "La Sexta Spain", id: "534" },
  { name: "Liverpool TV (LFC TV)", id: "826" },
  { name: "Logo TV USA", id: "849" },
  { name: "Las Estrellas", id: "924" },
  { name: "LCI France", id: "962" },
  { name: "Lifetime Network", id: "326" },
  { name: "Lifetime Movies Network", id: "389" },
  { name: "La7 Italy", id: "855" },
  { name: "LA7d HD+ Italy", id: "856" },
  { name: "Match Football 1 Russia", id: "136" },
  { name: "Match Football 2 Russia", id: "137" },
  { name: "Match Football 3 Russia", id: "138" },
  { name: "Match Premier Russia", id: "573" },
  { name: "Match TV Russia", id: "127" },
  { name: "МАТЧ! БОЕЦ Russia", id: "395" },
  { name: "Movistar Laliga", id: "84" },
  { name: "Movistar Liga de Campeones", id: "435" },
  ...
  { name: "M4 Sports Hungary", id: "265" },
  { name: "Movistar Supercopa de España", id: "437" },
  { name: "MTV UK", id: "367" },
  { name: "MTV USA", id: "371" },
  { name: "MUTV UK", id: "377" },
  { name: "M6 France", id: "470" },
  ...
  { name: "NHL Network USA", id: "663" },
  { name: "NFL RedZone", id: "667" },
  { name: "Nova Sport Bulgaria", id: "468" },
  { name: "Nova Sport Serbia", id: "582" },
  { name: "Nova Sports 1 Greece", id: "631" },
  { name: "Nova Sports 2 Greece", id: "632" },
  { name: "Nova Sports 3 Greece", id: "633" },
  { name: "Nova Sports 4 Greece", id: "634" },
  { name: "Nova Sports 5 Greece", id: "635" },
  { name: "Nova Sports 6 Greece", id: "636" },
  ...
  { name: "NBC USA", id: "53" },
  { name: "NBA TV USA", id: "404" },
  { name: "NBC Sports Philadelphia", id: "777" },
  { name: "NFL Network", id: "405" },
  { name: "NBC Sports Bay Area", id: "753" },
  { name: "NBC Sports Boston", id: "754" },
  { name: "NBC Sports California", id: "755" },
  { name: "NBCNY USA", id: "769" },
  { name: "Nova TV Bulgaria", id: "480" },
  { name: "Nova S Serbia", id: "847" },
  { name: "NewsNation USA", id: "292" },
  { name: "National Geographic (NGC)", id: "328" },
  { name: "NICK JR", id: "329" },
  { name: "NICK", id: "330" },
  ...
  { name: "OnTime Sports", id: "611" },
  { name: "ONE 1 HD Israel", id: "541" },
  { name: "ONE 2 HD Israel", id: "542" },
  { name: "Orange Sport 1 Romania", id: "439" },
  { name: "Orange Sport 2 Romania", id: "440" },
  { name: "Orange Sport 3 Romania", id: "441" },
  { name: "Orange Sport 4 Romania", id: "442" },
  ...
  { name: "Polsat Poland", id: "562" },
  { name: "Polsat Sport Poland", id: "47" },
  { name: "Polsat Sport 2 Poland", id: "50" },
  ...
  { name: "ProSieben (PRO7) DE", id: "730" },
  { name: "Premier Sports Ireland 1", id: "771" },
  { name: "PTV Sports", id: "450" },
  { name: "PDC TV", id: "43" },
  { name: "Premier Brasil", id: "88" },
  ...
  { name: "Pac-12 Network USA", id: "287" },
  { name: "PBS USA", id: "210" },
  { name: "Reelz Channel", id: "293" },
  { name: "RTE 1", id: "364" },
  { name: "RTE 2", id: "365" },
  { name: "RMC Sport 1 France", id: "119" },
  { name: "RMC Sport 2 France", id: "120" },
  { name: "RMC Story France", id: "954" },
  { name: "RTP 1 Portugal", id: "719" },
  { name: "RTP 2 Portugal", id: "720" },
  { name: "RTP 3 Portugal", id: "721" },
  { name: "Rai 1 Italy", id: "850" },
  { name: "Rai 2 Italy", id: "851" },
  { name: "Rai 3 Italy", id: "852" },
  { name: "Rai 4 Italy", id: "853" },
  { name: "Rai Sport Italy", id: "882" },
  { name: "Rai Premium Italy", id: "858" },
  { name: "Real Madrid TV Spain", id: "523" },
  { name: "RTL DE", id: "740" },
  { name: "RDS CA", id: "839" },
  { name: "RDS 2 CA", id: "840" },
  ...
  { name: "Sky Sports Football UK", id: "35" },
  { name: "Sky Sports+ Plus", id: "36" },
  { name: "Sky Sports Action UK", id: "37" },
  { name: "Sky Sports Main Event", id: "38" },
  { name: "Sky Sports Tennis UK", id: "46" },
  { name: "Sky sports Premier League", id: "130" },
  { name: "Sky Sports F1 UK", id: "60" },
  { name: "Sky Sports Cricket", id: "65" },
  { name: "Sky Sports Golf UK", id: "70" },
  { name: "Sky Sports 1 DE", id: "240" },
  { name: "Sky Sports 2 DE", id: "241" },
  { name: "Sky Sports Golf Italy", id: "574" },
  { name: "Sky Sport MotoGP Italy", id: "575" },
  { name: "Sky Sport Tennis Italy", id: "576" },
  { name: "Sky Sport F1 Italy", id: "577" },
  { name: "Sky Sports News UK", id: "366" },
  ...
  { name: "Sky Sport MAX Italy", id: "460" },
  { name: "Sky Sport UNO Italy", id: "461" },
  { name: "Sky Sport Arena Italy", id: "462" },
  { name: "Sky Sports Racing UK", id: "554" },
  { name: "Sky UNO Italy", id: "881" },
  { name: "SONY TEN 1", id: "885" },
  { name: "SONY TEN 2", id: "886" },
  { name: "SONY TEN 3", id: "887" },
  ...
  { name: "Sport TV1 Portugal", id: "49" },
  { name: "Sport TV2 Portugal", id: "74" },
  { name: "Sport TV4 Portugal", id: "289" },
  { name: "Sport TV3 Portugal", id: "454" },
  { name: "Sport TV5 Portugal", id: "290" },
  { name: "Sport TV6 Portugal", id: "291" },
  { name: "SIC Portugal", id: "722" },
  { name: "SEC Network USA", id: "385" },
  { name: "SporTV Brasil", id: "78" },
  { name: "SporTV2 Brasil", id: "79" },
  { name: "SporTV3 Brasil", id: "80" },
  ...
  { name: "Sportsnet Ontario", id: "406" },
  { name: "Sportsnet One", id: "411" },
  { name: "Sportsnet West", id: "407" },
  { name: "Sportsnet East", id: "408" },
  { name: "Sportsnet 360", id: "409" },
  { name: "Sportsnet World", id: "410" },
  { name: "SuperSport Grandstand", id: "412" },
  { name: "SuperSport PSL", id: "413" },
  { name: "SuperSport Premier league", id: "414" },
  { name: "SuperSport LaLiga", id: "415" },
  ...
  { name: "Sport1 Germany", id: "641" },
  { name: "S4C UK", id: "670" },
  { name: "Sport KLUB Golf Croatia", id: "710" },
  { name: "SAT.1 DE", id: "729" },
  ...
  { name: "8Sky Cinema Suspense Italy", id: "868" },
  { name: "Sky Sport 24 Italy", id: "869" },
  { name: "Sky Sport Calcio Italy", id: "870" },
  { name: "Sky Calcio 1 (251) Italy", id: "871" },
  { name: "Sky Calcio 2 (252) Italy", id: "872" },
  { name: "Sky Calcio 3 (253) Italy", id: "873" },
  { name: "Sky Calcio 4 (254) Italy", id: "874" },
  ...
  { name: "SSC Sport 1", id: "614" },
  { name: "SSC Sport 2", id: "615" },
  { name: "SSC Sport 3", id: "616" },
  { name: "SSC Sport 4", id: "617" },
  { name: "SSC Sport 5", id: "618" },
  { name: "SSC Sport Extra 1", id: "619" },
  { name: "SSC Sport Extra 2", id: "620" },
  { name: "SSC Sport Extra 3", id: "621" },
  { name: "Sport 1 Israel", id: "140" },
  { name: "Sport 2 Israel", id: "141" },
  { name: "Sport 3 Israel", id: "142" },
  { name: "Sport 4 Israel", id: "143" },
  { name: "Sport 5 Israel", id: "144" },
  { name: "Sport 5 PLUS Israel", id: "145" },
  { name: "Sport 5 Live Israel", id: "146" },
  { name: "Sport 5 Star Israel", id: "147" },
  ...
  { name: "SBS6 NL", id: "883" },
  { name: "Star Sports 1 IN", id: "267" },
  { name: "Star Sports Hindi IN", id: "268" },
  { name: "Showtime 2 USA (SHO2) USA", id: "792" },
  { name: "Showtime Showcase USA", id: "793" },
  { name: "Showtime Extreme USA", id: "794" },
  { name: "Showtime Family Zone (SHO Family Zone) USA", id: "795" },
  { name: "Showtime Next (SHO Next) USA", id: "796" },
  ...
  { name: "TNT Sports 1 UK", id: "31" },
  { name: "TNT Sports 2 UK", id: "32" },
  { name: "TNT Sports 3 UK", id: "33" },
  { name: "TNT Sports 4 UK", id: "34" },
  { name: "TSN1", id: "111" },
  { name: "TSN2", id: "112" },
  { name: "TSN3", id: "113" },
  { name: "TSN4", id: "114" },
  ...
  { name: "Telecinco Spain", id: "532" },
  { name: "TVE La 1 Spain", id: "533" },
  { name: "TVE La 2 Spain", id: "536" },
  { name: "TVI Portugal", id: "723" },
  { name: "TVI Reality Portugal", id: "724" },
  { name: "Teledeporte Spain (TDP)", id: "529" },
  { name: "TYC Sports Argentina", id: "746" },
  { name: "TVP Sport Poland", id: "128" },
  { name: "TNT Brasil", id: "87" },
  { name: "TNT Sports Argentina", id: "388" },
  { name: "TNT Sports HD Chile", id: "642" },
  { name: "Tennis Channel", id: "40" },
  { name: "Ten Sports PK", id: "741" },
  { name: "TUDN USA", id: "66" },
  { name: "Telemundo", id: "131" },
  { name: "TBS USA", id: "336" },
  { name: "TLC", id: "337" },
  { name: "TNT USA", id: "338" },
  { name: "TF1 France", id: "469" },
  { name: "TVA Sports", id: "833" },
  { name: "TVA Sports 2", id: "834" },
  ...
  { name: "TV2 Sport X Denmark", id: "808" },
  { name: "TV3 Sport Denmark", id: "809" },
  { name: "TV2 Sport Denmark", id: "810" },
  { name: "TV2 Denmark", id: "817" },
  { name: "TV2 Zulu", id: "818" },
  { name: "TV3+ Denmark", id: "819" },
  { name: "TVO CA", id: "842" },
  { name: "TV8 Turkey", id: "1005" },
  { name: "TV4 Hockey", id: "700" },
  { name: "TV3 Max Denmark", id: "223" },
  { name: "T Sports BD", id: "270" },
  { name: "TV4 Tennis", id: "701" },
  { name: "TV4 Motor", id: "702" },
  { name: "TV4 Sport Live 1", id: "703" },
  { name: "TV4 Sport Live 2", id: "704" },
  { name: "TV4 Sport Live 3", id: "705" },
  { name: "TV4 Sport Live 4", id: "706" },
  { name: "TV4 Sportkanalen", id: "707" },
  { name: "TV4 Football Sweden", id: "747" },
  { name: "Tennis+ 10", id: "709" },
  { name: "Tennis+ 12", id: "711" },
  { name: "TRT Spor TR", id: "889" },
  { name: "USA Network", id: "343" },
  { name: "Universal Kids USA", id: "668" },
  { name: "Univision", id: "132" },
  { name: "Unimas", id: "133" },
  { name: "Viaplay Sports 1 UK", id: "451" },
  { name: "Viaplay Sports 2 UK", id: "550" },
  ...
  { name: "VICE TV", id: "659" },
  { name: "Willow Cricket", id: "346" },
  { name: "Willow 2 Cricket", id: "598" },
  { name: "WWE Network", id: "376" },
  { name: "Win Sports+ Columbia", id: "392" },
  { name: "WETV USA", id: "655" },
  { name: "WDR DE", id: "734" },
  { name: "W9 France", id: "959" },
  { name: "YTV CA", id: "286" },
  { name: "YES Network USA", id: "763" },
  ...
  { name: "Ziggo Sport NL", id: "393" },
  { name: "Ziggo Sport 2 NL", id: "398" },
...
const SportsPage = () => {
  ...
  // ... (Keep existing SPECIAL_STREAM, CATEGORIES_TREE, normalizeCategory, getParentCategory, and the useEffect fetching PLAYLIST_URL) ...
  // NOTE: Insert your existing logic here for fetching the IPTV playlist. I am abbreviating it for clarity.
  const SPECIAL_STREAM = {
    ...
    // ... [Previous CATEGORIES_TREE and Helper Functions] ...
    
    // ... [Previous useEffect for fetch(PLAYLIST_URL)] ...

    // ... [Previous useEffect for filtering IPTV channels] ...
  ...
  return (
    <div className="pt-24 px-4 md:px-12 min-h-screen pb-20">
      ...
      {activeTab === 'iptv' && (
        <>
            {/* ... [INSERT YOUR EXISTING IPTV RENDER LOGIC HERE: Category buttons, Error states, Grid of displayedChannels, Pagination] ... */}
            {/* Note: I am not repeating the 200 lines of existing UI code here to save space, but you keep it exactly as it was inside this block. */}
            
            {!loading && !error && (
            <div className="flex flex-col gap-4 mb-8">
               {/* Categories Buttons Code... */}
            ...
            <div className="flex justify-center items-center gap-4 mt-12 mb-8">
                <button disabled={currentPage === 1} onClick={() => setCurrentPage(p => Math.max(1, p - 1))} className="p-3 rounded-full bg-[#19222b] text-white"><ChevronLeft size={24} /></button>
                <div className="text-center text-gray-500 text-xs animate-pulse">Page {currentPage} of {Math.ceil(displayedChannels.length/itemsPerPage) || 1}</div>
                <button disabled={currentPage >= Math.ceil(displayedChannels.length/itemsPerPage)} onClick={() => setCurrentPage(p + 1)} className="p-3 rounded-full bg-[#19222b] text-white"><ChevronRight size={24} /></button>
            </div>
        </>
      )}
